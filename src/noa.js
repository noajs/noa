// ┌───────────────────────────────────────────────────────----------──────────----------───┐ \\
// │ Noa: Javascript Sudo Framework and Toolbox                                             │ \\
// ├─────────────────────────────────────────────────────────────────----------─----------──┤ \\
// │ Copyright © 2015 Jacob Schatz(http://noajs.com)                                        │ \\
// ├──────────────────────────────────────────────────────────────----------───----------───┤ \\
// │ Licensed under the MIT (https://raw.githubusercontent.com/noajs/noa/master/LICENSE.txt)│ \\
// └─────────────────────────────────────────────────────────────────--------------------───┘ \\
